...
- **Modules**: the browser form of [`sal salmodule inspect`](#sal-salmodule). Enter a module reference and the JSON-LD ontology it publishes is shown as formatted JSON.
